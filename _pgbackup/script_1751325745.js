...
function downloadProgram(version) {
    ...
    if (version === 'mac_until_12') {
        downloadLink = "https://example.com/onedrive_mac_until_12.dmg"; // Substitua pelo link real
        alert("Download para Mac até 12 iniciado!\n\nLembre-se de substituir este link pelo link real do seu programa.");
    } else if (version === 'mac_12_onwards') {
        downloadLink = "https://example.com/onedrive_mac_12_onwards.dmg"; // Substitua pelo link real
